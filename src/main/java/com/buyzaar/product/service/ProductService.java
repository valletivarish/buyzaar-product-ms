...
public interface ProductService {
	...
	List<Product> getAllProducts(String cursorId, int limit, boolean goingBackward, String name, String category, List<String> tagIds, double minValue, double maxValue);
